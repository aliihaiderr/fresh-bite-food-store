  ...
  const handleSubmit = async (e)=>{
    ...
    if (firstName && email && password && confirmPassword) {
        if (password === confirmPassword) {
          ...
          alert('Match Your Confirm Password');
        }
    }
    else{
    ...
    <div className='p-3 md:p-4'>
      <div className='w-full max-w-sm bg-white m-auto flex flex-col p-4'>
          ...
          <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
            ...
            <input type={'text'} id='firstName' name='firstName' className='w-full bg-slate-200 mt-1 mb-2 px-2 py-1 rounded focus-within:outline-blue-300' value={data.firstName} onChange={handleonchange}/>
            <label htmlFor='lastName'>Last Name</label>
            <input type={'text'} id='lastName' name='lastName' className='w-full bg-slate-200 mt-1 mb-2 px-2 py-1 rounded focus-within:outline-blue-300' value={data.lastName} onChange={handleonchange}/>
            ...
            <button className='w-full max-w-[150px] m-auto bg-red-500 hover:bg-red-600 cursor-pointer rounded-full text-white text-xl font-medium py-1 mt-4'>Sign Up</button>
          </form>
